    ...
    <div id="header" class="container">
      ...
      <nav class="site-header-nav">
        <a
          ...
          href="https://github.com/soda-nl/vue3-treeselect/releases">
          v{{ require("../package.json").version }}
        </a>
        <span class="site-header-nav-item">
          <a
            class="github-button"
            href="https://github.com/soda-nl/vue3-treeselect"
            data-show-count="true"
            aria-label="Star soda-nl/vue3-treeselect on GitHub">
            Star
          </a>
        </span>
      </nav>
  ...
  <div class="container">
    <section id="main">
      ...
      <div id="content">
        ...
        <a href="https://github.com/soda-nl/vue3-treeselect">vue3-treeselect</a>
